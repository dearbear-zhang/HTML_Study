...
$('.back3').click(function(){
        location.href="index_my_address.html"
    }) 


//加载动画
// $(document).ready(function(){
//     $(".bodybox").css("height",$(document).height());     
//     $(".bodybox").css("width",$(document).width());  
// })
// //移除动画
// window.onload = function(){
//     setTimeout(function(){$('.bodybox').remove(); $('.spinner').remove();},500)
